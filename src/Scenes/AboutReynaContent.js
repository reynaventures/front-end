export const AboutReynaContent = () => {
    return (
        <main className="content">
            <section className="currency-info-wrp">
                <div className="currency-info">
                    <h1 className="currency-info-title txt-bold">A Leader in Digital Currency Investing</h1>
                    <span className="currency-info-subtitle txt-regular">We believe that digital currencies will revolutionize our legacy economic, political, and social systems. With that transformation comes a meaningful generational shift in how institutions and individuals approach investing. That’s where Reyna Ventures comes in.</span>
            ...
            <section className="currency-description-wrp">
                ...
                <div className="currency-description-item currency-description">
                    <div className="currency-description-item-wrp">
                        <h2 className="currency-description-title txt-medium">Our Story</h2>
                        <p className="currency-description-txt txt-regular">
                            As the digital currency market has emerged and evolved, Reyna has grown alongside it, becoming the leading partner to investors as they navigate and deploy capital into this new asset className.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <ul className="currency-features-list">
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">Our world is changing, it's becoming one digital and money as too
                            </h2>
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">Disclaimer
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">

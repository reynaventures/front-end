export const BuildingBlocksContent = () => {
    return (
        <main className="content">
            <section className="currency-info-wrp">
                <div className="currency-info">
                    <h1 className="currency-info-title txt-bold">Building Blocks</h1>
                ...
                <ul className="currency-features-list">
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info">
                            <h2 className="currency-features-list-item-title txt-medium">An Introduction to Bitcoin
                            </h2>
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info">
                            <h2 className="currency-features-list-item-title txt-medium">An Introduction to Ethereum
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info">
                            <h2 className="currency-features-list-item-title txt-medium">An Introduction to Polygon
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info">
                            <h2 className="currency-features-list-item-title txt-medium">An Introduction to Decentraland
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">

        ...
        <main className="content">
            <section className="currency-info-wrp">
                <div className="currency-info">
                    <h1 className="currency-info-title txt-bold">Get in Touch</h1>
                    <span className="currency-info-subtitle txt-regular">Whether you have specific investment inquiries or general questions about Grayscale Investments, the Grayscale team would be glad to help. After you complete the applicable form below, our team will be in touch.</span>
                </div>
            </section>
                ...
                <ul className="currency-features-list">
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info">
                            <h2 className="currency-features-list-item-title txt-medium">Leeds
                            </h2>
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info">
                            <h2 className="currency-features-list-item-title txt-medium">Mumbai
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">

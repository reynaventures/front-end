        ...
        <main className="content">
            <section className="currency-info-wrp">
                <div className="currency-info">
                    <h1 className="currency-info-title txt-bold">Frequently Asked Questions</h1>
                    <span className="currency-info-subtitle txt-regular">Select a category to get started, or select from the list of FAQs below. If you still have unanswered questions, we invite you to get in touch with our team directly.</span>
                </div>
            </section>
            <section className="currency-description-wrp">
                ...
                <div className="currency-description-item currency-description">
                    <div className="currency-description-item-wrp">
                        <h2 className="currency-description-title txt-medium">General Questions</h2>
            ...
            <div className="currency-features">
                <ul className="currency-features-list">
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">What is Reyna?
                            </h2>
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">Why should I own shares of the Products over purchasing digital assets outright?
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">What are the Products' fees?
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">How is each Product’s “Holdings” (non-GAAP) calculated?
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">Can I purchase shares of a Product in my retirement account?
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">How are the digital assets underlying each Product’s shares safeguarded?
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">What are the risks of investing in a Product?
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                    ...
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">What are the benefits of adding digital currencies to my portfolio?
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                                Digital currencies possess many unique qualities. Because digital currencies are borderless, fungible, and accessible, they may be a great way to diversify your portfolio. Additionally, because of these unique qualities, digital currencies have historically been uncorrelated with other more traditional asset classes, such as stocks and bonds. In a market environment with geopolitical uncertainty and volatility, investors may benefit from a non-correlated asset className.
                            </span>
                        </div>
                    </li>
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">Where can I find more information?
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">

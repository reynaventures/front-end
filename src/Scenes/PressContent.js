        ...
        <main className="content">
            <section className="currency-info-wrp">
                <div className="currency-info">
                    <h1 className="currency-info-title txt-bold">Press</h1>
                    <span className="currency-info-subtitle txt-regular">Recent company news and featured media coverage.</span>
                    <div className="currency-info-additional">
                        <button className="currency-info-additional-btn txt-medium">Read More</button>
            ...
            <section className="currency-description-wrp">
                ...
                <div className="currency-description-item currency-description">
                    <div className="currency-description-item-wrp">
                        <h2 className="currency-description-title txt-medium">Featured Appearances</h2>

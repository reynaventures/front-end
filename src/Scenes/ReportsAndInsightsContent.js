export const ReportsAndInsightContent = () => {
    return (
        <main className="content">
            <section className="currency-info-wrp">
                <div className="currency-info">
                    <h1 className="currency-info-title txt-bold">Reports & Insights</h1>
                ...
                <ul className="currency-features-list">
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info">
                            <h2 className="currency-features-list-item-title txt-medium">Weekly report (May 30- Jun 6)
                            </h2>
                            <span className="currency-features-list-item-subtitle txt-regular">
                                Avoid doing transactions using this wallet address during this period, other than the required 1 REIN (ERC-20) as stated above, to ensure that sufficient REIN remains in the wallet during the screenshots. Screenshots will be taken weekly from 14:00 to 24:00 (London Time, UTC +1). Wallets with insufficient REIN (ERC-20) during our screenshots WILL NOT QUALIFY for the airdrop.
                            </span>
                        </div>

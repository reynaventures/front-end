        ...
        <main className="content">
            <section className="currency-info-wrp">
                <div className="currency-info">
                    <h1 className="currency-info-title txt-bold">Digital Currency Investor Toolkit</h1>
                    <span className="currency-info-subtitle txt-regular">As the world’s largest digital currency asset manager, Reyna Ventures is a trusted partner for investors and financial advisors who want to learn more about the asset className. Understanding that the digital currency market can be challenging to research, we’ve consolidated all the information you need to start within the Digital Currency Toolkit, now available for download.</span>
                    <span className="currency-info-subtitle txt-regular">We know that digital currencies may not be a fit for everyone, but having an objective understanding of the asset className is increasingly important. As the market evolves, so will Reyna’s resources. We are committed to providing you with the most up-to-date intelligence on this new asset className.</span>
                    <div className="currency-info-additional">
                        <button className="currency-info-additional-btn txt-medium">Download Now</button>
                    </div>
                </div>
            </section>
            <section className="currency-description-wrp">
                ...
                <div className="currency-description-item currency-description">
                    <div className="currency-description-item-wrp">
                        <h2 className="currency-description-title txt-medium">In the Toolkit</h2>
                        <p className="currency-description-txt txt-regular">
                        Highlights Include: Bitcoin fundamentals, Bitcoin: the best performing asset of the 21st century, How to invest in Bitcoin
                        </p>
                    </div>
                </div>
            </section>
                ...
                <ul className="currency-features-list">
                    <li className="currency-features-list-item">
                        <div className="currency-features-list-item-info-content">
                            <h2 className="currency-features-list-item-title txt-medium">Digital Economy
                            </h2>

        ...
        <main class="content">
            <section class="currency-info-wrp">
                <div class="currency-info">
                    <h1 class="currency-info-title txt-bold">Get in Touch</h1>
                    <span class="currency-info-subtitle txt-regular">Whether you have specific investment inquiries or general questions about Grayscale Investments, the Grayscale team would be glad to help. After you complete the applicable form below, our team will be in touch.</span>
                </div>
            </section>

        ...
        <main class="content">
            <section class="currency-info-wrp">
                <div class="currency-info">
                    <h1 class="currency-info-title txt-bold">Frequently Asked Questions</h1>
                    <span class="currency-info-subtitle txt-regular">Select a category to get started, or select from the list of FAQs below. If you still have unanswered questions, we invite you to get in touch with our team directly.</span>
                </div>
            </section>
            <section class="currency-description-wrp">
                ...
                <div class="currency-description-item currency-description">
                    <div class="currency-description-item-wrp">
                        <h2 class="currency-description-title txt-medium">General Questions</h2>

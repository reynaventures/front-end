        ...
        <main class="content">
            <section class="currency-info-wrp">
                <div class="currency-info">
                    <h1 class="currency-info-title txt-bold">Press</h1>
                    <span class="currency-info-subtitle txt-regular">Recent company news and featured media coverage.</span>
            ...
            <section class="currency-description-wrp">
                ...
                <div class="currency-description-item currency-description">
                    <div class="currency-description-item-wrp">
                        <h2 class="currency-description-title txt-medium">Featured Appearances</h2>

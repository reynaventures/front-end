export const WaycContent = () => {
    return (
        <main class="content">
            <section class="currency-info-wrp">
                <div class="currency-info">
                    <h1 class="currency-info-title txt-bold">Weary Ape Yacht Club</h1>
                    <span class="currency-info-subtitle txt-regular">"Weary Ape Yacht Club" is a private collection of NFTs—unique digital collectibles.<br/><br/>
                        The Apes are stored as ERC-721 tokens on the Polygon blockchain and hosted on IPFS. With more than 360+ hand drawn traits, each NFT is unique and comes with a membership to an exclusive group of successful investors. Join an ambitious ever-growing community with multiple benefits and utilities.<br/><br/>
                        Once a week, 50% of royalties fees from "Weary Ape Yacht Club'' collections will be transferred into the "WAYC BANK''. These funds will be fully managed by the community (DAO), by you. They can be reinvested into the project, used to finance marketing campaigns voted by the community, giveaways… You will also be able to decide which portion to allocate as dividends in equal parts to bring passive income to the holders.</span>
                    <div class="currency-info-additional">
                        <a href="https://discord.gg/wearyapeyc" target="_blank"><button class="currency-info-additional-btn txt-medium">Join Discord</button></a>
                    </div>
                </div>
            </section>
            <section class="currency-description-wrp">
                <div class="currency-description-item currency-description-img-wayc">
                ...
                <div class="currency-description-item currency-description">
                    <div class="currency-description-item-wrp">
                        <h2 class="currency-description-title txt-medium">Beyond Time & Space</h2>
                        <p class="currency-description-txt txt-regular">
                            Join the club, and explore all the possibilities of the metaverse. We’re on a mission to build the premier Web 3.0 brand together with our community, driven by our shared passion for NFTs, gaming, and the metaverse.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <ul class="currency-features-list">
                    <li class="currency-features-list-item">
                        ...
                        <div class="currency-features-list-item-img">
                            <div class="wayc-benefits-item wayc-benefits-img1">
                                {/* <img src="img/currency-description-img.JPG" alt="currency" /> */}
                            </div>
                        </div>
                    </li>
